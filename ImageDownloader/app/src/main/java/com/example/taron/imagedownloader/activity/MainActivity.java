...
public class MainActivity extends AppCompatActivity {
    ...
    private void MyImageLoader(final Button button, final TextView editText) {
    ...
    private void httpLoader(TextView editText, String root) throws IOException {
        ...
        File file = new File(root + getString(R.string.fraction) +
                ImgProvider.getPosition().getImgNum() + getString(R.string.format_jpg));
